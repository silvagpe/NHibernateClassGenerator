...
{
    public class ClassGeneratorPostgres : ClassGenerator
    {

        private Tables _tables = null;

        public ClassGeneratorPostgres()
        {
            _tables = new TablesPostgres();
        }
        ...
        public override void MapByDataType(StreamWriter writer, ColumnModel columnModel)
        {
            switch (columnModel.DataType)
            {
                ...
                case "boolean": MapBoolean(writer, columnModel); break;
                case "integer": MapInteger(writer, columnModel); break;
                ...
                case "character": MapString(writer, columnModel); break;
                case "character varying": MapString(writer, columnModel); break;
                case "text": MapText(writer, columnModel); break;
                case "bytea": MapByteArray(writer, columnModel); break;
                case "uuid": MapGuid(writer, columnModel); break;
                case "timestamp": MapDatetime(writer, columnModel); break;
                case "timestamp without time zone": MapDatetime(writer, columnModel); break;
                case "date": MapDatetime(writer, columnModel); break;
                case "time without time zone": MapDatetime(writer, columnModel); break;
                case "double precision": MapDouble(writer, columnModel); break;
            }
        ...
        public override void MapDecimal(StreamWriter writer, ColumnModel columnModel)
        {
            ...
            if (!string.IsNullOrEmpty(columnModel.Scale))
                sb.Append(string.Format(".Scale({1})", columnModel.Precison, columnModel.Scale));
