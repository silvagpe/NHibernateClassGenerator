...
{
    public class TablesOracle : Tables
    {
        /// <summary>
        ...
        {
            string sql = @"SELECT COLUMN_NAME, DATA_TYPE, '' AS CHARACTER_MAXIMUM_LENGTH, '' AS NUMERIC_PRECISION, '' AS NUMERIC_SCALE, '' AS IS_NULLABLE
                            FROM ALL_TAB_COLS
                            WHERE TABLE_NAME = '{0}'";
