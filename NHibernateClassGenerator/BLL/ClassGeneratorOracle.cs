...
{
    public class ClassGeneratorOracle : ClassGenerator
    {
        private Tables _tables = null;

        public ClassGeneratorOracle()
        {
            _tables = new TablesOracle();
        }
        ...
        {
            switch (columnModel.DataType.ToLower())
            {
                ...
                case "varchar2": MapString(writer, columnModel); break;
                case "date": MapDatetime(writer, columnModel); break;
                case "number": MapInteger(writer, columnModel); break;
            }
