...
{
    public class DB_Postgres : IDatabase
    {
        public DB_Postgres()
        {
            ...
            StringConexao = String.Format("Server={0};Database={1};User ID={2};Password={3};",
        ...
        public DB_Postgres(string ipServidor, string nomeDatabase, string usuarioBancoDados, string senhaBancoDados, int portaBancoDados)
        {
            StringConexao = String.Format("Server={0};Database={1};User ID={2};Password={3};", ipServidor, nomeDatabase, usuarioBancoDados, senhaBancoDados);
            ListaParametros = new List<NpgsqlParameter>();
            BeginTransaction(IsolationLevel.ReadUncommitted);
        }

        public DB_Postgres(string ipServidor, string nomeDatabase, int portaBancoDados, bool conexaoConfiavel)
        {
        ...
        public DB_Postgres(string connstr)
        {
        ...
        private List<NpgsqlParameter> ListaParametros { get; set; }
        ...
        public void AddParam(string nomeParametro, DbType tipoParametro, object valor)
        {
            ...
            NpgsqlParameter param = new NpgsqlParameter(nomeParametro, tipoParametro);
        ...
        public object ExecuteScalar(string queryString, bool fechaConexao)
        {
            ...
            try
            {
                NpgsqlConnection sqlConn = (NpgsqlConnection)OpenConnection();
                NpgsqlCommand sqlCommand = new NpgsqlCommand(queryString, sqlConn);
        ...
        public DataTable Select(string queryString, bool fechaConexao)
        {
            ...
            {
                NpgsqlConnection sqlConn = (NpgsqlConnection)OpenConnection();
                da.SelectCommand = new NpgsqlCommand(queryString, sqlConn);
