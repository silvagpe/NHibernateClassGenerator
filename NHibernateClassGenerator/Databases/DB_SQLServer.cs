...
{
    public class DB_SQLServer : IDatabase
    {
        public DB_SQLServer()
        {
        ...
        public DB_SQLServer(string ipServidor, string nomeDatabase, string usuarioBancoDados, string senhaBancoDados, int portaBancoDados)
        {
        ...
        public DB_SQLServer(string ipServidor, string nomeDatabase, int portaBancoDados, bool conexaoConfiavel)
        {
        ...
        public DB_SQLServer(string connstr)
        {
        ...
        private List<SqlParameter> ListaParametros { get; set; }
        ...
        public void AddParam(string nomeParametro, DbType tipoParametro, object valor)
        {
            ...
            SqlParameter param = new SqlParameter(nomeParametro, tipoParametro);
        ...
        public object ExecuteScalar(string queryString, bool fechaConexao)
        {
            ...
            try
            {
                SqlConnection sqlConn = (SqlConnection)OpenConnection();
